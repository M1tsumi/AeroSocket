...
### Fixed
- **CI Warning**: Fixed unused assignment warning in server module
- **Debug Logging**: Added connection counter logging for better observability

## [0.1.2] - 2025-11-29

### Fixed
- **CI Formatting**: Applied rustfmt formatting to pass CI checks
- **Code Style**: Consistent formatting across WASM module
